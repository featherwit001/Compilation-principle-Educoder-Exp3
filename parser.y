...
Stmt:     Exp SEMI {$$=new NExpStmt(*$1);$$->line=$1->line;}
        ...
        | IF LP Exp RP Stmt ELSE Stmt {$$=new NIfElseStmt(*$3,*$5,*$7);$$->line=yylineno;}
...
Exp:      Exp ASSIGNOP Exp {$$=new NAssignment(*(new std::string("ASSIGNOP")),*$1,ASSIGNOP,*$3);$$->line=yylineno;}//$$结点type_id空置未用，正好存放运算符
        ...
        | Exp PLUSASS Exp   {$$=new NAssignment(*(new std::string("PLUSASS")),*$1,PLUSASS,*$3);$$->line=yylineno; std::cout<<"E+E"<<std::endl;}//复合赋值运算
